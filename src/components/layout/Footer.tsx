...
const footerLinks = {
  plataforma: [
    ...
    { name: "Sobre ALAMEXA", path: "/about" },
    { name: "DevHub", path: "/devhub" },
  ],
  cuenta: [
    { name: "Mi Cuenta", path: "/account" },
    { name: "Mis Trueques", path: "/trades" },
    { name: "Dashboard", path: "/dashboard" },
    { name: "Carrito", path: "/cart" },
    { name: "Publicar Producto", path: "/products/new" },
  ],
  soporte: [
    { name: "Centro de Ayuda", path: "/help" },
    { name: "Cómo funciona", path: "/about#how-it-works" },
    { name: "Seguridad", path: "/about#security" },
...
const features = [
  { icon: RefreshCw, text: "Trueque Seguro" },
  { icon: Shield, text: "Verificación" },
